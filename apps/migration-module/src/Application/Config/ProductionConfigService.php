...
final class ProductionConfigService
{
    ...
    private const PROFILES = [
        'safe' => [
            'rate_limit' => ['source_rpm' => 20, 'target_rpm' => 20, 'heavy_rpm' => 6],
            'batch_size' => 50,
            'chunk_size' => 250,
            'retry_policy' => ['max_retries' => 6, 'base_delay_ms' => 250, 'max_delay_ms' => 5000],
            'api_timeout' => 20,
            'parallel_workers' => 2,
            'queue_max_size' => 1000,
        ...
        'balanced' => [
            'rate_limit' => ['source_rpm' => 35, 'target_rpm' => 40, 'heavy_rpm' => 8],
            'batch_size' => 100,
            'chunk_size' => 500,
            'retry_policy' => ['max_retries' => 6, 'base_delay_ms' => 200, 'max_delay_ms' => 5000],
            'api_timeout' => 20,
            'parallel_workers' => 4,
            'queue_max_size' => 2000,
        ...
        'aggressive' => [
            'rate_limit' => ['source_rpm' => 55, 'target_rpm' => 65, 'heavy_rpm' => 12],
            'batch_size' => 250,
            'chunk_size' => 1000,
            'retry_policy' => ['max_retries' => 4, 'base_delay_ms' => 120, 'max_delay_ms' => 3500],
            'api_timeout' => 15,
            'parallel_workers' => 6,
            'queue_max_size' => 5000,
